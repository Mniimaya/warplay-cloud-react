...
function Advantages() {
  return (
    ...
    <div className={styles.advantages__container}>
      <div className={styles.advantages__card}>
        ...
        <p className={styles.advantages__description}>Наш модуль доступен на все популярные ОС и&nbsp;работает на всех
          компьютерах.</p>
        <a href="/#" className={`${styles.advantages__link} link`}>Открыть в браузере</a>
      </div>
    </div>
  ...
  <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_7610_131" result="shape"/>
      ...
      <picture>
        <source src={mapDesk} media="(min-width:768px)"/>
        <img className={styles.advantages__locationMap} src={mapMob} width="556" height="435" alt="Карта локаций серверов. Москва."/>
      </picture>
    </div>

	...
	return (
		<section className={`${styles.feedback} container`} id="feedback-container">
			...
			<div className={styles.feedback__container}>
				<p>
					Остались вопросы? <span>Заполните форму и мы постараемся Вам помочь</span>
				</p>

				<form action="#" method="get" className={styles.formFeedback}>
					<fieldset>
						<label>
						...
						<label className={styles.labelTextarea}>
							...
							<span className={styles.counterSymbol}>
								<span>0</span>/500
							</span>
						</label>
					</fieldset>
